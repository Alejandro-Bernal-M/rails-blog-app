...
RSpec.describe 'User post index page', type: :feature do
  before do
    ...
    @post1 = Post.create(Title: 'Post 1', Text: 'This is the body of Post 1', CommentsCounter: 2, LikesCounter: 5,
                         author: @user1)
    @post2 = Post.create(Title: 'Post 2', Text: 'This is the body of Post 2', CommentsCounter: 1, LikesCounter: 3,
                         author: @user1)
  ...
  it 'displays a section for pagination if there are more posts than fit on the view' do
    ...
    @post3 = Post.create(Title: 'Post 3', Text: 'This is the Text of Post 3', CommentsCounter: 0, LikesCounter: 0,
                         author: @user1)
    @post4 = Post.create(Title: 'Post 4', Text: 'This is the body of Post 4', CommentsCounter: 0, LikesCounter: 0,
                         author: @user1)
    @post5 = Post.create(Title: 'Post 5', Text: 'This is the body of Post 5', CommentsCounter: 0, LikesCounter: 0,
                         author: @user1)
